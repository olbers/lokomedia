...
switch($_GET[act]){
  ...
  case "tambahgalerifoto":
    ...
    echo "</select></td></tr>
          <tr><td>Keterangan</td>  <td> <textarea name='keterangan' style='width: 600px; height: 50px;'></textarea></td></tr>
  ...
  case "editgalerifoto":
    ...
    echo "</select></td></tr>
          <tr><td>Keterangan</td>   <td> <textarea name='keterangan' style='width: 600px; height: 50px;'>$r[keterangan]</textarea></td></tr>
          <tr><td>Gambar</td>       <td> :  ";
          if ($r[gbr_gallery]!=''){
